  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: dark ? Colors.white.withOpacity(0.2) : Colors.white.withOpacity(0.5),
        border: Border.all(color: dark ? SColors.accent : SColors.softGrey, width: 1),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: dark ? SColors.darkOptional.withOpacity(0.5) : SColors.white.withOpacity(0.6),
            child: Center(
              child: Text(
                name,
