...
class GlossySnackBar {
  static void show(
    ...
    final backgroundColor = isError
        ...
        : (isDarkMode
        ? TColors.darkPrimaryContainer.withOpacity(0.2)
        : TColors.lightPrimaryContainer.withOpacity(0.5));

    final gradientColors = isError
        ? [Colors.red.withOpacity(0.4), Colors.redAccent.withOpacity(0.2)]
        : isDarkMode
        ? [
      TColors.darkPrimaryContainer.withOpacity(0.6),
      TColors.darkSecondaryContainer.withOpacity(0.3),
    ]
        : [
      Colors.white.withOpacity(0.8),
      TColors.lightPrimaryContainer.withOpacity(0.6),
    ];
